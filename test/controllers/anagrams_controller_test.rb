...
class AnagramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anagram" do
    assert_difference('Anagram.count') do
      post anagrams_url, params: { anagram: { result: @anagram.result, word1: @anagram.word1, word2: @anagram.word2 } }, as: :json
    end
  ...
  test "should update anagram" do
    patch anagram_url(@anagram), params: { anagram: { result: @anagram.result, word1: @anagram.word1, word2: @anagram.word2 } }, as: :json
    assert_response 200
  end
